...
df_25 <- read.xlsx("../../UpdatedDataBlind.xlsx")
```
...
df_24_plot_data<- sample_df24 |> group_by(strBlockint) |>
  summarize(Average = mean(Average))
ggplot() +
  geom_point(data = df_24_plot_data, aes(x = strBlockint, y = Average, color = "2024")) +
  geom_smooth(data = df_24_plot_data, aes(x = strBlockint, y = Average, color = "2024"), method = "lm", se = FALSE) +
  geom_point(data = df_25_plot_data, aes(x = strBlockint, y = Average, color = "2025")) +
  geom_smooth(data = df_25_plot_data, aes(x = strBlockint, y = Average, color = "2025"), method = "lm", se = FALSE) +
  labs(title = "Average Scores Over Time for 2024 & 2025", x = "Rotation Block", y = "Average Score", color = "Year") +
  scale_color_manual(values = c("2024" = "purple", "2025" = "orange")) +
