...
Here is a more advanced function that can automatically 
...
multinom_logit <- function(var, df, predictors = NULL, ref_level = "3") {
  ...
  # Convert the dependent variable to factor and set reference level
  var_factor_name <- paste0(var, "_factor")
  df_copy[[var_factor_name]] <- factor(df_copy[[var]])
  
  # Check if reference level exists in the data
  ...
  # Update formula to use the factor version
